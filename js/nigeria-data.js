// Complete 36 States + FCT (Abuja) of Nigeria with all 774 Official LGAs
const NIGERIA_STATES_AND_LGAS = {
  ...
  "Rivers": [
    ...
    "Gokana", "Ikwerre", "Khana", "Obio/Akpor", "Oba/Egbema/Ndoni",
  ...
  "Abia": [
    ...
    "Isuikwuato", "Obi Ngwa", "Ohafia", "Osisioma", "Ugwunagbo",
  ...
  "Niger": [
    ...
    "Mokwa", "Moya", "Paikoro", "Rafi", "Rijau", "Shiroro", "Suleja", "Tafa",
    "Wushishi"
  ],
  "Ondo": [
  ...
  "Osun": [
    "Atakunmosa East", "Atakunmosa West", "Adedayo", "Aiyedaade", "Aiyedire",
    "Boluwaduro", "Boripe", "Ede North", "Ede South", "Ife Central", "Ife East",
    "Ife North", "Ife South", "Egbedore", "Ejigbo", "Ifedayo", "Ifelodun",
